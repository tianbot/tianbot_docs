            ...
            items: [
              ...
              { text: '收货清单', link: '/tianbot/list' },
              {
                ...
                items: [
                  ...
                  { text: '软件环境配置', link: '/tianbot/guide/chapter1' },
                  { text: 'ROS基础功能', link: '/tianbot/guide/chapter2' },
                  { text: 'SLAM建图', link: '/tianbot/guide/chapter3' },
                  { text: '自主导航', link: '/tianbot/guide/chapter4' },
                ],
              },
              {
                text: '实验手册',
                collapsed: true,
                items: [
                  { text: '实验一 实验工具的使用', link: '/tianbot/experiment/chapter1' },
                  { text: '实验二 ROS控制底盘运动', link: '/tianbot/experiment/chapter2' },
                  { text: '实验三 摄像头图像获取', link: '/tianbot/experiment/chapter3' },
                  { text: '实验四 二维码追踪导航', link: '/tianbot/experiment/chapter4' },
                  { text: '实验五 激光SLAM建图', link: '/tianbot/experiment/chapter5' },
                  { text: '实验六 自主导航', link: '/tianbot/experiment/chapter6' },
                  { text: '实验七 常用的局部导航', link: '/tianbot/experiment/chapter7' },
                  { text: '实验八 Action与语音控制', link: '/tianbot/experiment/chapter8'},
                  { text: '实验八 视觉SLAM', link: '/tianbot/experiment/chapter9' },
                  { text: '实验九 人机交互GUI', link: '/tianbot/experiment/chapter10' },
                ],
              },
            ...
            items: [
              ...
              { text: '收货清单', link: '/tianracer/list' },
              {
                ...
                items: [
                  ...
                  { text: '软件环境配置', link: '/tianracer/guide/chapter1' },
                  { text: 'ROS基础功能', link: '/tianracer/guide/chapter2' },
                  { text: 'SLAM建图', link: '/tianracer/guide/chapter3' },
                  { text: '自主导航', link: '/tianracer/guide/chapter4' },
                ],
              },
              {
                text: '实验手册',
                collapsed: true,
                items: [
                  { text: '实验一 实验工具的使用', link: '/tianracer/experiment/chapter1' },
                  { text: '实验二 ROS控制底盘运动', link: '/tianracer/experiment/chapter2' },
                  { text: '实验三 反应式方法', link: '/tianracer/experiment/chapter3' },
                  { text: '实验四 定位与建图SLAM', link: '/tianracer/experiment/chapter4' },
                  { text: '实验五 Cartographer与TEB详解', link: '/tianracer/experiment/chapter5' },
                  { text: '实验六 自主导航', link: '/tianracer/experiment/chapter6' },
                  { text: '实验七 多点导航', link: '/tianracer/experiment/chapter7' },
                  { text: '实验八 深度学习与视觉导航', link: '/tianracer/experiment/chapter8'},
            ...
            items: [
              ...
              { text: '收货清单', link: '/tianbot_mini/list' },
              {
                ...
                items: [
                  ...
                  { text: '使用环境配置', link: '/tianbot_mini/guide/chapter1' },
                  {
                    text: '快速上手',
                    collapsed: true,
                    items: [
                      { text: '命令行的讲解', link: '/tianbot_mini/quick_start/' },
                      { text: 'ROS控制mini移动', link: '/tianbot_mini/quick_start/chapter1' },
                      { text: 'rviz的使用', link: '/tianbot_mini/quick_start/chapter2' },
                      { text: '发布者编程', link: '/tianbot_mini/quick_start/chapter3' },
                      { text: '订阅者编程', link: '/tianbot_mini/quick_start/chapter4' },
                      { text: '话题通讯（发布/订阅）', link: '/tianbot_mini/quick_start/chapter5' },
                    ],
                  },
                  { text: 'ROS基础功能', link: '/tianbot_mini/guide/chapter2' },
                  {
                    text: 'SLAM建图',
                    collapsed: true,
                    link: '/tianbot_mini/slam/',
                    items: [
                      { text: 'Gmapping建图', link: '/tianbot_mini/slam/chapter1' },
                      { text: 'Hector SLAM建图', link: '/tianbot_mini/slam/chapter2' },
                      { text: 'Cartographer建图', link: '/tianbot_mini/slam/chapter3' },
                    ],
                  },
                  {
                    text: '自主导航',
                    ...
                    items: [
                      { text: 'move_base框架分析', link: '/tianbot_mini/navigation/chapter1' },
                    ],
                  },
                  {
                    text: '多机器人联动',
                    collapsed: true,
                    items: [
                      { text: '配置WIFI环境', link: '/tianbot_mini/swarm/chapter1' },
                      { text: '第二台机器人多机模式的配置', link: '/tianbot_mini/swarm/chapter2' },
                      { text: '两台机器人的联动', link: '/tianbot_mini/swarm/chapter3' },
                      { text: '仿真与实体之间的联动', link: '/tianbot_mini/swarm/chapter4' },
                    ],
                  },
                  { text: '机器人集群', link: '/tianbot_mini/guide/chapter3' },
                  {
                    text: '更多功能应用',
                    collapsed: true,
                    items: [
                      { text: 'Arduino转圈讲解', link: '/tianbot_mini/more_application/' },
                      { text: 'python转圈、点灯', link: '/tianbot_mini/more_application/chapter1' },
                      { text: '超声波测距', link: '/tianbot_mini/more_application/chapter2' },
                      { text: 'ROSECHO', link: '/tianbot_mini/more_application/chapter3' },
                      { text: 'TTS与ASR节点编程', link: '/tianbot_mini/more_application/chapter4' },
                      { text: 'HTML机器人的GUI搭建', link: '/tianbot_mini/more_application/chapter5' },
                      { text: '图传机器人', link: '/tianbot_mini/more_application/chapter6' },
                      { text: '增加IMU工具', link: '/tianbot_mini/more_application/chapter7' },
                      { text: 'TTS语音播报', link: '/tianbot_mini/more_application/chapter8' },
                    ],
                  },
                  { text: '固件更新', link: '/tianbot_mini/guide/chapter5' },
                  { text: '致谢', link: '/tianbot_mini/guide/chapter6' },
                ],
              },
    ...
    
          {
            ...
            items: [
              ...
              { text: '使用手册', link: '/rosecho/guide/' },
              {
                ...
                collapsed: true,
                items: [
                  { text: '云端问答', link: '/rosecho/guide/chapter1' },
                  { text: 'rosecho功能包详解', link: '/rosecho/guide/chapter2' },
                  { text: '语音遥控', link: '/rosecho/guide/chapter3' },
                  { text: '用户自定义问答', link: '/rosecho/guide/chapter4' },
                  { text: 'AIUI配置', link: '/rosecho/guide/chapter5' },
                ],
              },
