    ...
    '/': [
        {
          ...
          },
          {
            ...
            items: [
              ...
              { text: '选购说明', link: '/tianbot_mini/multi_vs_single' },
              {
                text: 'Single 系列 使用手册',
                collapsed: true,
                items: [
                  { text: '使用指引', link: '/tianbot_mini/single/guide/' },
                  { text: '使用环境配置', link: '/tianbot_mini/single/guide/env-config' },
                  {
                    text: '快速上手',
                    collapsed: true,
                    items: [
                      { text: '命令行的讲解', link: '/tianbot_mini/single/quick_start/command-line-note' },
                      { text: 'ROS 控制 mini 移动', link: '/tianbot_mini/single/quick_start/move-mini-by-ros' },
                      { text: 'rviz 的使用', link: '/tianbot_mini/single/quick_start/use-of-rviz' },
                      { text: '发布者编程', link: '/tianbot_mini/single/quick_start/publisher-program' },
                      { text: '订阅者编程', link: '/tianbot_mini/single/quick_start/subscriber-program' },
                      { text: '话题通讯（发布/订阅）', link: '/tianbot_mini/single/quick_start/topic-communication' },
                    ],
                  },
                  { text: 'ROS 基础功能', link: '/tianbot_mini/single/guide/basic-feature' },
                  {
                    text: 'SLAM 建图',
                    collapsed: true,
                    link: '/tianbot_mini/single/slam/',
                    items: [
                      { text: 'Gmapping 建图', link: '/tianbot_mini/single/slam/gmapping' },
                      { text: 'Hector SLAM 建图', link: '/tianbot_mini/single/slam/hector-slam' },
                      { text: 'Cartographer 建图', link: '/tianbot_mini/single/slam/cartographer' },
                    ],
                  },
                  {
                    text: '自主导航',
                    collapsed: true,
                    link: '/tianbot_mini/single/navigation/',
                    items: [
                      { text: '自主导航', link: '/tianbot_mini/single/navigation/self-navigation' },
                      { text: 'move_base 框架分析', link: '/tianbot_mini/single/navigation/move-base' },
                    ],
                  },
                  {
                    text: '更多功能应用',
                    collapsed: true,
                    items: [
                      { text: 'Arduino 转圈讲解', link: '/tianbot_mini/single/more_application/circle-by-arduino' },
                      { text: 'python 转圈、点灯', link: '/tianbot_mini/single/more_application/circle-and-lighting-by-python' },
                      { text: '超声波测距', link: '/tianbot_mini/single/more_application/ultrasonic-range' },
                      { text: 'ROSECHO', link: '/tianbot_mini/single/more_application/rosecho-voice-hci' },
                      { text: 'TTS 与 ASR 节点编程', link: '/tianbot_mini/single/more_application/tts-and-asr-program' },
                      { text: 'HTML 机器人的 GUI 搭建', link: '/tianbot_mini/single/more_application/html-gui' },
                      { text: '图传机器人', link: '/tianbot_mini/single/more_application/image-transmission' },
                      { text: '增加 IMU 工具', link: '/tianbot_mini/single/more_application/imu-tools' },
                      { text: 'TTS 语音播报', link: '/tianbot_mini/single/more_application/tts-voice-broadcast' },
                    ],
                  },
                ],
              },
              {
                ...
                collapsed: true,
                items: [
                  { text: '使用指引', link: '/tianbot_mini/multi/guide/' },
                  { text: '使用环境配置', link: '/tianbot_mini/multi/guide/env-config' },
                  {
                    text: '快速上手',
                    collapsed: true,
                    items: [
                      { text: '命令行的讲解', link: '/tianbot_mini/multi/quick_start/command-line-note' },
                      { text: 'ROS 控制 mini 移动', link: '/tianbot_mini/multi/quick_start/move-mini-by-ros' },
                      { text: 'rviz 的使用', link: '/tianbot_mini/multi/quick_start/use-of-rviz' },
                      { text: '发布者编程', link: '/tianbot_mini/multi/quick_start/publisher-program' },
                      { text: '订阅者编程', link: '/tianbot_mini/multi/quick_start/subscriber-program' },
                      { text: '话题通讯（发布/订阅）', link: '/tianbot_mini/multi/quick_start/topic-communication' },
                    ],
                  },
                  { text: 'ROS 基础功能', link: '/tianbot_mini/multi/guide/basic-feature' },
                  {
                    text: 'SLAM 建图',
                    collapsed: true,
                    link: '/tianbot_mini/multi/slam/',
                    items: [
                      { text: 'Gmapping 建图', link: '/tianbot_mini/multi/slam/gmapping' },
                      { text: 'Hector SLAM 建图', link: '/tianbot_mini/multi/slam/hector-slam' },
                      { text: 'Cartographer 建图', link: '/tianbot_mini/multi/slam/cartographer' },
                    ],
                  },
                  {
                    text: '自主导航',
                    collapsed: true,
                    link: '/tianbot_mini/multi/navigation/',
                    items: [
                      { text: '自主导航', link: '/tianbot_mini/multi/navigation/self-navigation' },
                      { text: 'move_base 框架分析', link: '/tianbot_mini/multi/navigation/move-base' },
                    ],
                  },
                  {
                    text: '多机器人联动',
                    collapsed: true,
                    items: [
                      { text: '配置 WIFI 环境', link: '/tianbot_mini/multi/swarm/wifi-config' },
                      { text: '第二台机器人多机模式的配置', link: '/tianbot_mini/multi/swarm/2nd-wifi-config' },
                      { text: '两台机器人的联动', link: '/tianbot_mini/multi/swarm/cooperate-of-two-robot' },
                      { text: '仿真与实体之间的联动', link: '/tianbot_mini/multi/swarm/cooperate-of-sim2real' },
                      { text: 'tianbot mini 与 rmtt 的空地协同', link: '/tianbot_mini/multi/swarm/swarm-of-mini-and-rmtt' },
                      { text: 'mini 与 rmtt 的协同救援、物资递送任务', link: '/tianbot_mini/multi/swarm/collaborative_rescue_and_material_delivery' },
                    ],
                  },
                  {
                    text: '更多功能应用',
                    collapsed: true,
                    items: [
                      { text: 'Arduino 转圈讲解', link: '/tianbot_mini/multi/more_application/circle-by-arduino' },
                      { text: 'python 转圈、点灯', link: '/tianbot_mini/multi/more_application/circle-and-lighting-by-python' },
                      { text: '超声波测距', link: '/tianbot_mini/multi/more_application/ultrasonic-range' },
                      { text: 'ROSECHO', link: '/tianbot_mini/multi/more_application/rosecho-voice-hci' },
                      { text: 'TTS 与 ASR 节点编程', link: '/tianbot_mini/multi/more_application/tts-and-asr-program' },
                      { text: 'HTML 机器人的 GUI 搭建', link: '/tianbot_mini/multi/more_application/html-gui' },
                      { text: '图传机器人', link: '/tianbot_mini/multi/more_application/image-transmission' },
                      { text: '增加 IMU 工具', link: '/tianbot_mini/multi/more_application/imu-tools' },
                      { text: 'TTS 语音播报', link: '/tianbot_mini/multi/more_application/tts-voice-broadcast' },
                    ],
                  },
