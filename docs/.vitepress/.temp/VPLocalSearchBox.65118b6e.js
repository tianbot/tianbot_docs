...
import { u as unrefElement, t as tryOnScopeDispose, a as useData, c as computedAsync, b as useSessionStorage, d as useLocalStorage, w as watchDebounced, o as onKeyStroke, e as useRouter, f as useEventListener, g as useScrollLock, h as dataSymbol, p as pathToFile } from "./app.js";
import { _ as _export_sfc } from "./plugin-vue_export-helper.cc2b3d55.js";
import "medium-zoom";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.79d6a17b.js") };
/*!
* tabbable 6.2.0
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        var _a3, _b, _c, _d;
        _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a3 = results.value) == null ? void 0 : _a3.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="localsearch-label" class="VPLocalSearchBox" data-v-38300f9d><div class="backdrop" data-v-38300f9d></div><div class="shell" data-v-38300f9d><form class="search-bar" data-v-38300f9d><label${ssrRenderAttr("title", _ctx.placeholder)} id="localsearch-label" for="localsearch-input" data-v-38300f9d><svg class="search-icon" width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-38300f9d><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-38300f9d><circle cx="11" cy="11" r="8" data-v-38300f9d></circle><path d="m21 21l-4.35-4.35" data-v-38300f9d></path></g></svg></label><div class="search-actions before" data-v-38300f9d><button class="back-button"${ssrRenderAttr("title", unref($t)("modal.backButtonTitle"))} data-v-38300f9d><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-38300f9d><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 12H5m7 7l-7-7l7-7" data-v-38300f9d></path></svg></button></div><input${ssrRenderAttr("value", unref(filterText))}${ssrRenderAttr("placeholder", _ctx.placeholder)} id="localsearch-input" aria-labelledby="localsearch-label" class="search-input" data-v-38300f9d><div class="search-actions" data-v-38300f9d>`);
        if (!disableDetailedView.value) {
          _push2(`<button class="${ssrRenderClass([{ "detailed-list": unref(showDetailedList) }, "toggle-layout-button"])}"${ssrRenderAttr("title", unref($t)("modal.displayDetails"))} data-v-38300f9d><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-38300f9d><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 14h7v7H3zM3 3h7v7H3zm11 1h7m-7 5h7m-7 6h7m-7 5h7" data-v-38300f9d></path></svg></button>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<button class="clear-button" type="reset"${ssrIncludeBooleanAttr(disableReset.value) ? " disabled" : ""}${ssrRenderAttr("title", unref($t)("modal.resetButtonTitle"))} data-v-38300f9d><svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true" data-v-38300f9d><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 5H9l-7 7l7 7h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2Zm-2 4l-6 6m0-6l6 6" data-v-38300f9d></path></svg></button></div></form><ul${ssrRenderAttr("id", ((_b = results.value) == null ? void 0 : _b.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = results.value) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = results.value) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-38300f9d><!--[-->`);
        ssrRenderList(results.value, (p, index) => {
          _push2(`<li role="option"${ssrRenderAttr("aria-selected", selectedIndex.value === index ? "true" : "false")} data-v-38300f9d><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
            selected: selectedIndex.value === index
          }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-38300f9d><div data-v-38300f9d><div class="titles" data-v-38300f9d><span class="title-icon" data-v-38300f9d>#</span><!--[-->`);
          ssrRenderList(p.titles, (t, index2) => {
            _push2(`<span class="title" data-v-38300f9d><span class="text" data-v-38300f9d>${t}</span><svg width="18" height="18" viewBox="0 0 24 24" data-v-38300f9d><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 18l6-6l-6-6" data-v-38300f9d></path></svg></span>`);
          });
          _push2(`<!--]--><span class="title main" data-v-38300f9d><span class="text" data-v-38300f9d>${p.title}</span></span></div>`);
          if (unref(showDetailedList)) {
            _push2(`<div class="excerpt-wrapper" data-v-38300f9d>`);
            if (p.text) {
              _push2(`<div class="excerpt" inert data-v-38300f9d><div class="vp-doc" data-v-38300f9d>${p.text}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="excerpt-gradient-bottom" data-v-38300f9d></div><div class="excerpt-gradient-top" data-v-38300f9d></div></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></a></li>`);
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-38300f9d>${ssrInterpolate(unref($t)("modal.noResultsText"))} &quot;<strong data-v-38300f9d>${ssrInterpolate(unref(filterText))}</strong>&quot; </li>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</ul><div class="search-keyboard-shortcuts" data-v-38300f9d><span data-v-38300f9d><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.navigateUpKeyAriaLabel"))} data-v-38300f9d><svg width="14" height="14" viewBox="0 0 24 24" data-v-38300f9d><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m-7 7l7-7l7 7" data-v-38300f9d></path></svg></kbd><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.navigateDownKeyAriaLabel"))} data-v-38300f9d><svg width="14" height="14" viewBox="0 0 24 24" data-v-38300f9d><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m7-7l-7 7l-7-7" data-v-38300f9d></path></svg></kbd> ${ssrInterpolate(unref($t)("modal.footer.navigateText"))}</span><span data-v-38300f9d><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.selectKeyAriaLabel"))} data-v-38300f9d><svg width="14" height="14" viewBox="0 0 24 24" data-v-38300f9d><g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-38300f9d><path d="m9 10l-5 5l5 5" data-v-38300f9d></path><path d="M20 4v7a4 4 0 0 1-4 4H4" data-v-38300f9d></path></g></svg></kbd> ${ssrInterpolate(unref($t)("modal.footer.selectText"))}</span><span data-v-38300f9d><kbd${ssrRenderAttr("aria-label", unref($t)("modal.footer.closeKeyAriaLabel"))} data-v-38300f9d>esc</kbd> ${ssrInterpolate(unref($t)("modal.footer.closeText"))}</span></div></div></div>`);
      }, "body", false, _parent);
    };
  }
});
const VPLocalSearchBox_vue_vue_type_style_index_0_scoped_38300f9d_lang = "";
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/vitepress@1.0.0-beta.6_@algolia+client-search@4.19.1_search-insights@2.7.0/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-38300f9d"]]);
export {
