...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"use_guide/rmtt/experiment/chapter9.md","filePath":"use_guide/rmtt/experiment/chapter9.md"}');
const _sfc_main = { name: "use_guide/rmtt/experiment/chapter9.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("use_guide/rmtt/experiment/chapter9.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const chapter9 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  chapter9 as default
};
