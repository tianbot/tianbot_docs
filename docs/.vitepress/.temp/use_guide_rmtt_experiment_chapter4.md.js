...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"use_guide/rmtt/experiment/chapter4.md","filePath":"use_guide/rmtt/experiment/chapter4.md"}');
const _sfc_main = { name: "use_guide/rmtt/experiment/chapter4.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("use_guide/rmtt/experiment/chapter4.md");
