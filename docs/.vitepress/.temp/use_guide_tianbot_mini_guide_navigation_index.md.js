...
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"use_guide/tianbot_mini/guide/navigation/index.md","filePath":"use_guide/tianbot_mini/guide/navigation/index.md"}');
const _sfc_main = { name: "use_guide/tianbot_mini/guide/navigation/index.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("use_guide/tianbot_mini/guide/navigation/index.md");
