...
现在，ROSECHO就可以完成一个普通智能音箱的对话、查询天气、唱歌、垃圾分类等语音交互。查看[云端问答](/rosecho/guide/chapter1.md)可以了解更多ROSECHO能够自主回答的问题。
...
云端问答库是由官方维护的。查看[云端问答](/rosecho/guide/chapter1.md)可以了解更多ROSECHO能够自主回答的问题。
### 说：运行TTS文本转语音
