...
AIUI的云端主要有`过滤`、`语义技能`、`兜底设置`、`后处理`四个部分。其中最重要的是语义技能。语音技能的处理分为四个步骤，`自定义技能`->`自定义问答-`>`设备人设`->`技能商店`，以下是详细介绍。如果您需要为项目定制开发，请[联系我们](/about)。
...
设备的姓名、性别等属性进行了模糊化处理，以免和唤醒词、发音人特征不符。社会关系、职业、个性、喜好等等都按照智能机器人进行设定。如果您需要定制更加鲜明的机器人人设，请[联系我们](/about)。下面是部分举例。
